...
## How to use `esy-texinfo`?

`esy-texinfo` can be used from both NPM and directly from Github.

### From NPM 

`esy-texinfo` is deployed on NPM can be found
[here](https://www.npmjs.com/package/TODO).

You can simply run `esy add esy-texinfo` to install it, or specify it in
...
{
  "dependencies": {
    "esy-texinfo": "esy-packages/esy-texinfo"
  }
}
```
...
```diff
  "dependencies": {
+   "esy-texinfo": "esy-packages/esy-texinfo#<commit hash>"
  }
```
